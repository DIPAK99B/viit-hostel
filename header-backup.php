...
<html lang="en">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="deleteit.php">VIIT</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      if(isset($_SESSION['username'])){
        ...
        if($_SESSION['role']=="student"){
          ...
          echo '  <a class="nav-link active" aria-current="page" href="student.php">STUDENT</a> ';
          echo '</li>';
        }
        elseif($_SESSION['role']=="admin"){
          echo '<li class="nav-item">';
          echo '  <a class="nav-link active" aria-current="page" href="admin.php">ADMIN</a> ';
          echo '</li>';
        }
      }
    ...
    -->
      ...
      if(isset($_SESSION['username'])){
        ...
        echo `<button onclick="window.location.href='logout.php'" style = "border:none ">Logout</button>`;
      }
      else {
        echo `<button onclick="window.location.href='loginpage.php'" style = "border:none ">Login</button>`;
        echo `<span > &nbsp&nbsp&nbsp&nbsp </span>`;
        # <!-- <button class="btn btn-outline-success">Sign Up</button> -->
        echo `<button onclick="window.location.href='signuppage.php'" style = "border:none ">Sign Up</button>`;
      }
